...
const tips = [
  ...
  'Завжди знімай макіяж перед сном, щоб шкіра відпочивала.',
  'Використовуй зволожуючий крем щоранку та ввечері.',
  'Пий більше води — це допомагає шкірі залишатися свіжою.',
  'Раз на тиждень роби легкий пілінг для оновлення клітин.',
  'Використовуй сонцезахисний крем навіть у хмарні дні.',

  'Мий голову не щодня, щоб не пересушувати волосся.',
  'Використовуй кондиціонер для м’якості та блиску.',
  'Раз на тиждень роби живильну маску для волосся.',
  'Не розчісуй мокре волосся — краще підсуши рушником.',
  'Старайся менше використовувати фен і праску.',

  'Регулярно зволожуй шкіру лосьйоном після душу.',
  'Приймай контрастний душ для тонусу та гарного кровообігу.',
  'Раз на тиждень використовуй скраб для гладкої шкіри.',
  'Під час сну носи вільний одяг, щоб тіло відпочивало.',
  'Робота з фізичною активністю допомагає підтримувати здоров’я шкіри.',

  'Завжди мий пензлики та спонжі від макіяжу.',
  'Обирай тональний засіб під свій тип шкіри.',
  'Зберігай косметику в прохолодному та сухому місці.',
  'Не використовуй прострочені косметичні продукти.',
  'Підбирай відтінки помади та тіней під свій настрій і образ.'
];
